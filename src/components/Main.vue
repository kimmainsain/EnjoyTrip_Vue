<template>
  <b-row id="cube-slider">
    <b-col id="title" cols="9">
      <br>
      <br>
      <div id="marks">
        <i class="fa-solid fa-apple-whole fa-2xl">  T h e   e d e n</i>
      </div>
        <div class="slider">
          <div class="container">
...
export default {
  ...
  mounted() {
    ...
    document
      .getElementById("cube-slider")
      .addEventListener("wheel", myFunction);

    // Code for IE and Firefox
    document
      .getElementById("cube-slider")
      .addEventListener("mousewheel", myFunction);
...
.slider {
  ...
  perspective: 600px;
  /* background-color: pink; Add your desired background color here */
}
